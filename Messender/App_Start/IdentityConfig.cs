...
namespace Messender
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            //var from = "vova.belmach@mail.ru";
            //var pass = "15975310895623vova";

            var from = "messendertest@mail.ru";
            var pass = "15975310895623Vladimir!";
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            string accountSid = "ACb648bfea583da19bb7a7a1eef425c33c";

            string accountToken = "deeb714089f55ec9305126e5f677299b";

            TwilioClient.Init(accountSid, accountToken);

            var messageToSend = MessageResource.Create(
                from: new PhoneNumber("+18599273917"),
